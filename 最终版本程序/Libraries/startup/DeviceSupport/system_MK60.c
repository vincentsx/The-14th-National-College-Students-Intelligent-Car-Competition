...
//-------------------------------------------------------------------------------------------------------------------
//  MK60DN_CLOCK 为 0  内核频率 100M  总线频率50M  flex_bus频率50M  flash频率25M
//  MK60DN_CLOCK 为 1  内核频率 150M  总线频率75M  flex_bus频率50M  flash频率25M
//  MK60DN_CLOCK 为 2  内核频率 180M  总线频率90M  flex_bus频率60M  flash频率30M
//-------------------------------------------------------------------------------------------------------------------
#define MK60DN_CLOCK    2


//-------------------------------------------------------------------------------------------------------------------
//  MK60FX_CLOCK 为 0  内核频率 150M  总线频率75M  flex_bus频率50M  flash频率25M
//  MK60FX_CLOCK 为 1  内核频率 180M  总线频率90M  flex_bus频率60M  flash频率25.7M
//  MK60FX_CLOCK 为 2  内核频率 200M  总线频率100M  flex_bus频率66.6M  flash频率28.5M
//-------------------------------------------------------------------------------------------------------------------
#define MK60FX_CLOCK    1
...
void div_set(void)
{
    ...
    switch(MK60FX_CLOCK)
    {
        ...
        case 2:
        {
            temp_clkdiv = (uint32_t)0x01260000u;
            temp_c5 = MCG_C5_PRDIV0(4-1);
            temp_c6 = MCG_C6_PLLS_MASK | MCG_C6_VDIV0(32-16);
