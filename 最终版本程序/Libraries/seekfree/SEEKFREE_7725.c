...
{
    uart_putchar(uart5, 0x00);uart_putchar(uart5, 0xff);uart_putchar(uart5, 0x01);uart_putchar(uart5, 0x01);//发送四个字节命令
    uart_putbuff(uart5, (uint8_t *)imgaddr, imgsize);   //再发送图像
}
